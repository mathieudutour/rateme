...
public final class BulletinManager: NSObject {
    ...
    public var cardPadding: BulletinPadding = .regular
    ...
    let rootItem: BulletinItem
    var itemsStack: [BulletinItem]
    var previousItem: BulletinItem?
...
extension BulletinManager {
    ...
    public func prepareAndPresent(above: UIViewController) {
        prepare()
    ...
    public func displayActivityIndicator(color: UIColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)) {
...
extension BulletinManager {
    ...
    func refreshCurrentItemInterface() {
